...
Hi! I am currently a PhD student in a joint training program between **Fudan University** and **Shanghai AI Lab**, under the supervision of [Professor Tao Chen](http://www.it.fudan.edu.cn/Data/View/2989) and [Professor Wanli Ouyang](https://wlouyang.github.io/). And I’m also mentored by [Researcher Nanqing Dong](https://scholar.google.com/citations?user=0DX2YsQAAAAJ&hl=en) at Shanghai AI Lab. My current research interests are AI4Science and Multimodal.  
I have published papers with total google scholar citations <a href='https://scholar.google.com/citations?hl=zh-CN&user=gShUHBAAAAAJ'><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a>.
